<?php
  ...
  if (isset($_GET['submit'])) {
    ...
    $option = $_GET['option'];
    if ($option == "Select") {
      $sqlsubj = "SELECT * FROM tbl_tutors WHERE tutor_name LIKE '%$search%'";
    } else {
      $sqlsubj  = "SELECT * FROM tbl_tutors WHERE tutor_language = '$option'";
    }
  } 
}else{
            ...
            <div class="w3-row">
                ...
                <div class="w3-half" style="padding-right:4px">
                    <p> <select class="w3-input w3-block w3-round w3-border" name="option">
                            ...
                            <option value="In Spanish">In Spanish</option>
                            <option value="In Hindi">In Hindi</option>
                            <option value="In Malay">In Malay</option>
...
<div class="w3-grid-template">
  ...
  foreach ($rows as $tutors) {
    ...
    $tlang = $tutors['tutor_language'];
    echo "<div class='flip-card w3-margin'>";
    echo "<div class='flip-card-inner'>";
    echo" <div class='flip-card-front' <h4>$tname</h4>";
    echo "<img src=../assets/tutors/$tid.jpg" .
         " style='width:300px;height:300px;'>
         
      </div>";
      echo "<div class='flip-card-back'>
        <h4>$tname</h4>
        <p>Descriction:$tdesc </p>
        <p>Email: $temail </p><p>Phome Number: $tphone </p><p>Language: $tlang </p>
